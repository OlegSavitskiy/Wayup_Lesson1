...
let city = 'Krivyi Rih';
let country = 'Ukraine';
let population = 634780;
let footbalStadium = true;
...
console.log('Плошадь прямоугольника равна ' + rectangleArea + ' см^2');
...
console.log('Расстояние между городами составляет ' + distance + ' км');
